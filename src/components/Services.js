...
const features = [
    { name: "ReactJS", icon: <SiReact className="w-12 h-12" />, duration: "duration-150" },
    { name: "Tailwind CSS", icon: <SiTailwindcss className="w-12 h-12" />, duration: "duration-200" },
    { name: "Styled Components", icon: <SiStyledcomponents className="w-12 h-12" />, duration: "duration-300" },
    { name: "Material UI", icon: <SiMaterialui className="w-12 h-12" />, duration: "duration-500" },
    { name: "Ant Design", icon: <SiAntdesign className="w-12 h-12" />, duration: "duration-700" },
        ...
        <div className="flex flex-wrap justify-center gap-4">
            {
                features.map((feature, key) => (
                    <div key={key} className={`${feature.duration} ${menuContext.menuId === "features" ? "translate-y-0 opacity-100" : "-translate-y-12 opacity-0"}`}>
